...
async function commentMediaId(
  ig,
  media_id,
  commentContent,
  commentIfAlreadyCommented = false,
  extraInfo = new Object()
) {
  let alreadyExists = ig.db
    .get("comments")
  ...
  if (commentIfAlreadyCommented || !alreadyExists) {
    ...
    let link =
      "https://www.instagram.com/p/" + parser.instagramIdToUrlSegment(media_id);
    ...
    return console.log(
      "Commented media https://www.instagram.com/p/".green +
